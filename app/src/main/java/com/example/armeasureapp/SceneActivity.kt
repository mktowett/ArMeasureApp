...
class SceneActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(this@SceneActivity, arrayOf(
                Manifest.permission.CAMERA
            ), 1002
            )
        }
        ...
        mFabMenu = findViewById<View>(R.id.fab_menu) as FloatingActionButton
        mFabClear = findViewById<View>(R.id.fab_clear) as FloatingActionButton
        mFabWidth = findViewById<View>(R.id.fab_width) as FloatingActionButton
        mFabHeight = findViewById<View>(R.id.fab_height) as FloatingActionButton
        mFabCapture = findViewById<View>(R.id.fab_capture) as FloatingActionButton
        ...
        sk_height_control!!.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
    ...
    private fun saveDialog() {
        val mBuilder = AlertDialog.Builder(this@SceneActivity)
        val mView = layoutInflater.inflate(R.layout.dialog_save, null)
        val et_measure = mView.findViewById(R.id.et_measure) as EditText
        ...
        mBuilder.setPositiveButton(
            ...
            } else Toast.makeText(this@SceneActivity, "Title can't be empty", Toast.LENGTH_SHORT)
                .show()
        }
...
//                SnackbarUtility.showSnackbarTypeLong(settingsButton, "Failed to take screenshot");
                Toast.makeText(this@SceneActivity, "Failed to take screenshoot", Toast.LENGTH_LONG)
                    .show()
            }
    ...
    fun saveBitmapToDisk(bitmap: Bitmap, filename: String) {
        try {
            ...
            Toast.makeText(this@SceneActivity, "Error writing screenshoot : $e", Toast.LENGTH_SHORT)
                .show()
        }
    }
